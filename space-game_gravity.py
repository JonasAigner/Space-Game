...
class Rocket(VectorSprite):
    ...
    def update(self, seconds):
        VectorSprite.update(self, seconds)
        # gravit auf black hole (number 2)
        diffvector = VectorSprite.numbers[2].pos - self.pos
        length = diffvector.length() # abstand zum loch
        diffvector.normalize_ip()   # hat jetzt richtige Richtung und länge 1
        gravity = diffvector * 1000  * 1/length  # gravitationsstärke
        self.move += gravity
...
class Planet(VectorSprite):
    ...
    def _overwrite_parameters(self):
        ...
        self.r, self.g, self.b = random.choice(farblist)
        self.picture = random.choice((PygView.images["planet1"], PygView.images["planet2"], PygView.images["planet3"], PygView.images["planet4"]))
        
class Black_hole(VectorSprite):
    
    def _overwrite_parameters(self):
        self._layer = 2 
        self.kill_on_edge = True
        x = 400
        self.pos = pygame.math.Vector2(x, -200)
        x1 = random.choice((-10, -7, -3, -5, -1, 9, -8, 0, 0, 0, -2, -4, -1, -1, -2, -2, -2, -1))
     #   self.move = pygame.math.Vector2(x1, -y)
        self.radius = 50  # random.randint(4, 50)

    def create_image(self):
        self.image = pygame.Surface((100,100))
        pygame.draw.circle( self.image, (255, 255, 255), (50,50), self.radius)
        self.image.set_colorkey((0,0,0))
        self.image.convert_alpha()
        self.image0 = self.image.copy()
        self.rect = self.image.get_rect()
...
class Monster4(Monster1):
    ...
    def create_image(self):
        self.image = PygView.images["enemy4"]
        self.image0 = self.image.copy()
        self.rect = self.image.get_rect()
...
class PygView(object):
    ...
    def load_sounds(self):
        PygView.shot1 = pygame.mixer.Sound(os.path.join("data", "Laser_shoot 1.wav"))
        PygView.shot2 = pygame.mixer.Sound(os.path.join("data", "Laser_shoot 2.wav"))
        PygView.shot3 = pygame.mixer.Sound(os.path.join("data", "Laser_shoot 3.wav"))
        PygView.shot4 = pygame.mixer.Sound(os.path.join("data", "Laser_shoot 4.wav"))
        PygView.expl1 = pygame.mixer.Sound(os.path.join("data", "Explosion 1.wav"))
        PygView.expl2 = pygame.mixer.Sound(os.path.join("data", "Explosion 2.wav"))
        PygView.powerup = pygame.mixer.Sound(os.path.join("data", "powerup1.wav"))
        
        PygView.soundshootlist = [PygView.shot1, PygView.shot3, PygView.shot4]
        PygView.soundexpllist = [PygView.expl1, PygView.expl2]
        PygView.soundpoweruplist = [PygView.powerup]
        
        # ---- load music ----
        self.music1 = pygame.mixer.music.load(os.path.join("data", "through space.ogg"))
    ...
    def load_sprite_images(self):
        ...
        PygView.images["planet1"] = pygame.image.load(os.path.join(
                        "data", "planet1.png"))
        size = random.randint(100, 800)
        PygView.images["planet1"] = pygame.transform.scale(PygView.images["planet1"], (size, size))
                        
        PygView.images["planet2"] = pygame.image.load(os.path.join(
                        "data", "planet2.png"))
        
        PygView.images["planet3"] = pygame.image.load(os.path.join(
                        "data", "planet3.png"))
        size = random.randint(100, 800)
        PygView.images["planet3"] = pygame.transform.scale(PygView.images["planet3"], (size, size))
        
        PygView.images["planet4"] = pygame.image.load(os.path.join(
                        "data", "planet4.png"))
        size = random.randint(100, 800)
        PygView.images["planet4"] = pygame.transform.scale(PygView.images["planet4"], (size, size))
                        
        PygView.images["enemy4"] = pygame.image.load(os.path.join(
                        "data", "bluecarrier2.png"))
    ...
    def prepare_sprites(self):
        ...
        self.blackholegroup = pygame.sprite.Group()
        ...
        Black_hole.groups = self.allgroup, self.blackholegroup
        ...
        self.hole1 = Black_hole()  # number 2
            ...
            for event in pygame.event.get():
                ...
                # ------- pressed and released key ------
                    ...
                    if event.key == pygame.K_TAB:
                        self.player1.fire()
                        sound = random.choice(PygView.soundshootlist)
                        sound.play()
                    ...
                    if event.key == pygame.K_v:
                        ...
                        sound = random.choice(PygView.soundexpllist)
                        sound.play()
                        self.player1.kill()
            ...
            for p in self.playergroup:
                ...
                for b in crashgroup:
                    if (b.r, b.g, b.b) == (ROT[0], ROT[1], ROT[2]):
                        ...
                        pass
                    sound = random.choice(PygView.soundpoweruplist)
                    sound.play()
